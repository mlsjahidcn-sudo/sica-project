...
本项目使用外部 Supabase PostgreSQL 数据库，**必须正确配置才能运行**。
...
- [连接池优化](./docs/supabase-connection-pooling.md)
- [安全修复摘要](./SECURITY_FIX_SUMMARY.md)

### ⚠️ 安全提醒

- **切勿提交 `.env.local` 到 Git**（已在 .gitignore 中）
- **定期轮换 API 密钥**（建议每 90 天）
- **Service Role Key 拥有完全管理员权限**，务必保密
```
